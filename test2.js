...
.glbox{
    width: calc(16.666% - 20px); /* Six columns layout */
    margin: 10px;
}
...
@media screen and (max-width: 1600px) {
    .glbox {
        width: calc(20% - 20px); /* Five columns layout */
    }
}
...
@media screen and (max-width: 700px) {
  ...
  <path fill="${color}" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
    ...
    function adjustMasonryLayout() {
        ...
        const columnCount = Math.floor(grid.clientWidth / (boxes[0].offsetWidth + 20)); // 计算列数
        ...
        boxes.forEach(box => {
            ...
            box.style.left = `${columnIndex * (boxes[0].offsetWidth + 20)}px`;
            columnHeights[columnIndex] += box.offsetHeight + 20;
        });
